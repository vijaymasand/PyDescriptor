# PyDescriptorC* and PyDescriptor:
...
To solve this, we have developed PyDescriptorC* (earlier known as PyDescriptor). It computes 112,194 molecular descriptors, including topological, atom-pair, quantum chemical, chirality-based descriptors for a molecule. 
...
https://sites.google.com/view/pydescriptorcstar/pydes-gpu?authuser=0
and
YouTube video link:
